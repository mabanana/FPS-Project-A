...
static var TEST_GUN_A := GunMetadataModel.new("Test SMG", 3, 50, 12, 1, 75, 100, 3, 1, 1, 1.5)
static var TEST_GUN_B := GunMetadataModel.new("Test 2-Shot Pistol", 70, 200, 2, 5, 90, 12, 2, 2, 2, 1.2)
static var TEST_GUN_C := GunMetadataModel.new("Test Shotgun", 3, 10, 1, 2, 60, 10, 5, 10, 2, 1.2)
static var TEST_GUN_D := GunMetadataModel.new("Test Sniper", 150, 200, 1.5, 3, 95, 4, 5, 1, 2, 1.2)
